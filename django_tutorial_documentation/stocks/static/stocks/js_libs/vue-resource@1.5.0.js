...
!(function(t, e) {
      ...
      i(function() {
        if (n.state !== t)
          for (; n.deferred.length; ) {
            ...
            try {
              0 === n.state
                ? i("function" == typeof o ? o.call(void 0, n.value) : n.value)
                : 1 === n.state &&
                  ("function" == typeof r
                    ? i(r.call(void 0, n.value))
                    : s(n.value));
            } catch (t) {
              s(t);
            }
  ...
  function b(t, e, n) {
    return (
      l((n = n || {})) && (n = n.call(e)),
      T(t.bind({ $vm: e, $options: n }), t, { $options: n })
    );
  }
  function g(t, e) {
    var n, o;
    if (h(t)) for (n = 0; n < t.length; n++) e.call(t[n], t[n], n);
    else if (m(t)) for (o in t) s.call(t, o) && e.call(t[o], t[o], o);
    return t;
  }
  var w =
    Object.assign ||
                      ...
                      if (E(r) && "" !== r)
                        if (
                          ...
                          (r = r.toString()),
                            o &&
                              "*" !== o &&
                              (r = r.substring(0, parseInt(o, 10))),
                            i.push(O(e, r, P(e) ? n : null));
                        else if ("*" === o)
                          Array.isArray(r)
                            ? r.filter(E).forEach(function(t) {
  ...
  function O(t, e, n) {
    return (
      (e = "+" === t || "#" === t ? C(e) : encodeURIComponent(e)),
    ...
    return new o(function(e) {
      ...
      (n = function(n) {
        ...
        "load" === r && null !== s ? (u = 200) : "error" === r && (u = 500),
          u && window[i] && (delete window[i], document.body.removeChild(o)),
          e(t.respondWith(s, { status: u }));
      }),
        (window[i] = function(t) {
          s = JSON.stringify(t);
        }),
    ...
    return new o(function(e) {
      ...
      (t.abort = function() {
        ...
        l(t.downloadProgress) &&
          n.addEventListener("progress", t.downloadProgress),
        l(t.progress) &&
          /^(POST|PUT)$/i.test(t.method) &&
          n.upload.addEventListener("progress", t.progress),
        l(t.uploadProgress) &&
          n.upload &&
          n.upload.addEventListener("progress", t.uploadProgress),
  ...
  function k(t) {
    ...
    return new o(function(n) {
      ...
      t.headers.forEach(function(t, e) {
        ...
        e(r, { body: i, method: s, headers: u }).then(
          (o = function(e) {
      ...
      d(t)
        ...
        : ((i = t),
          "undefined" != typeof Blob &&
            i instanceof Blob &&
            ((this.bodyBlob = t),
            (0 === (r = t).type.indexOf("text") ||
              -1 !== r.type.indexOf("json")) &&
              (this.bodyText = ((n = t),
              new o(function(t) {
            ...
            if (l(i)) {
              ...
              (c =
                ...
                "undefined" != typeof console &&
                  a &&
                  console.warn("[VueResource warn]: " + c);
          }
          var c;
        }
        return (
    ...
    return (
      ...
      n(new B(t)).then(
        ...
        function(t) {
          ...
          return (
            t instanceof Error &&
              ((e = t), "undefined" != typeof console && console.error(e)),
            o.reject(t)
          );
        }
      )
  ...
  function D(t, e, n, o) {
    var r = this || {},
      i = {};
    return (
      g((n = w({}, D.actions, n)), function(n, s) {
        (n = T({ url: t, params: w({}, e) }, o, n)),
          (i[s] = function() {
            return (r.$http || N)(
              (function(t, e) {
                var n,
                ...
                switch (e.length) {
                  case 2:
                    ...
                    break;
                  case 1:
                    /^(POST|PUT|PATCH)$/i.test(o.method)
                      ? (n = e[0])
                      : (r = e[0]);
                    break;
                  case 0:
      ...
      header: function(t) {
        g(
          w(
            {},
            N.headers.common,
            t.crossOrigin ? {} : N.headers.custom,
            N.headers[p(t.method)]
          ),
          function(e, n) {
      ...
      cors: function(t) {
        if (c) {
          ...
          (n.protocol === e.protocol && n.host === e.host) ||
            ((t.crossOrigin = !0), (t.emulateHTTP = !1), R || (t.client = U));
        }
      }
    }),
    (N.interceptors = [
